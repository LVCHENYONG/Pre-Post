...
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256, use_wandb=False,hebing=False, shuchu='',chutu='fake_B'):
...
class Visualizer():
    ...
    def plot_current_losses(self, epoch, counter_ratio, losses):
        ...
        if list(losses.keys()) != self.plot_data['legend']:
            self.plot_data = {'X': [], 'Y': [], 'legend': list(losses.keys())}
